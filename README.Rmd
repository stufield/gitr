...
You can install the released version of gitr from [CRAN](https://CRAN.R-project.org) with:
...
you push. An example workflow can be found here: <https://github.com/r-lib/actions/tree/master/examples>.
