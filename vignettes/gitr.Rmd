...
system-level git commands from within `R`. Contains wrappers
...
In the meantime please see the package [README](https://github.com/stufield/gitr/blob/main/README.md)
